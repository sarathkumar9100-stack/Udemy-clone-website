...
This is a simple and clean **Udemy-clone-website** created using **HTML** and **basic CSS**. It highlights my work, showcases my skills, and provides an easy way for others to connect with me. The design focuses on clarity, usability, and a smooth browsing experience.

### 🔥 Features

* Clean and minimal layout
* Easy-to-navigate sections (About, Skills, Projects, Contact)
* Fully responsive structure (if applicable — remove if not)
